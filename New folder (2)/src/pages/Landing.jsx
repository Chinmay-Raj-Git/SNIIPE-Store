      ...
      <div className="relative h-full flex items-center justify-center px-6 text-center">
        <div className="max-w-4xl">
          ...
          <div className="animate-slide-up" style={{ animationDelay: '0.5s', opacity: 0 }}>
            <p className="text-lg md:text-2xl mb-10 inline-block px-6 py-2.5 rounded-xl"
          ...
          <div className="animate-slide-up" style={{ animationDelay: '0.7s', opacity: 0 }}>
            <Link to="/home" className="inline-flex items-center gap-3 px-12 py-4 rounded-xl text-lg font-semibold shadow-2xl transition-all duration-300 hover:scale-105 group"
