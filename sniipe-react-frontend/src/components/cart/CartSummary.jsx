...
export default function CartSummary({
  ...
  return (
    <div className="cart-summary-sticky" style={{ backgroundColor: theme.surface, border: `1px solid ${theme.border}`, borderRadius: '16px', padding: '24px', position: 'sticky', top: '120px' }}>
